...
@export_range(-1.0,2.0, .01) var contrast: float = 1.01
@export_range(-1.0,2.0, .05) var brightness: float = 0
@export_range(-1.0,2.0, .05) var saturation: float = 1.1
@export_range(-1.0,2.0, .05) var gamma: float = 0.9
...
func initialize_computer_shader() -> void:
	...
	var glsl_file : RDShaderFile = load("res://Assets/Compositor Effects/ColorCorrection.glsl")
