...
class_name Dithering

var rd : RenderingDevice
var shader : RID
var pipeline : RID

@export_range(0.0,1.0) var dithering_intesity : float = .02
...
func _render_callback(_callback_type: int, render_data: RenderData) -> void:
	...
	push_constants.append(dithering_intesity)
...
func initialize_computer_shader() -> void:
	...
	var glsl_file : RDShaderFile = load("res://Assets/Compositor Effects/Dithering.glsl")
